...
<form action="JoinCon" method="post">
    ...
    <div class="">
        ...
        <main id="" class="">
            <div class="row">
            <form action="UpdateReviewCon2" method="post">
                <div class="col-12 post-text">
                	<%if(loginReview.getReview_type()==1){ %>
                	<input type="hidden" class="post-name" name="title" value="${loginReview.title}">
                	<input type="text" name="activity_title" value="${loginReview.activity_title}" readonly>
                	<%}else{ %>
                	...
                	<input type="hidden" name="review_type" value="${loginReview.review_type}">
