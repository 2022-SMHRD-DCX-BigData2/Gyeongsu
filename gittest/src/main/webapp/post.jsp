...
<body>
    ...
    <div class="">
        ...
        <main id="" class="">
            <div class="row">
                <div class="col-12">
                    <input type="text" class="post-name" placeholder="제목">
                </div>
                <div class="input-group mb-3 comment post-text">
                    <textarea    class="form-control" placeholder="로그인후 이용가능합니다" aria-label="Recipient's username" aria-describedby="button-addon2"></textarea>
